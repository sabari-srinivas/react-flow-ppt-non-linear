...
const CARDS = [
  {
    ...
    icon: '👁️',
    title: 'AI can SEE',
    accent: '#4e83c3', // Changed to blue
    bgGrad: 'linear-gradient(135deg, #ffffff 0%, #f0f6ff 100%)', // Blue gradient
  ...
  },
  {
    ...
    title: 'AI can TOUCH',
    accent: '#4e83c3', // Changed to blue
    bgGrad: 'linear-gradient(135deg, #ffffff 0%, #eff5ff 100%)', // Blue gradient
  ...
  },
  {
    ...
    title: 'AI can SPEAK',
    accent: '#4e83c3', // Changed to blue
    bgGrad: 'linear-gradient(135deg, #ffffff 0%, #f1f7ff 100%)', // Blue gradient
  ...
  },
  {
    ...
    accent: '#4e83c3', // Changed to blue
    bgGrad: 'linear-gradient(135deg, #ffffff 0%, #eef4ff 100%)', // Blue gradient
...
export default function Slide9Interactive() {
  ...
  return (
    <motion.div className="slide-container" style={{ ...slideContainer, ...styles.root }}>
      ...
      <motion.div
        initial={topGridIntro.initial}
        animate={topGridIntro.animate}
        transition={topGridIntro.transition}
        style={styles.grid4}
      >
        {CARDS.map((c, i) => (
          <motion.button
      ...
      {/* Bottom Text */}
      <motion.div
        initial={bottomTextIntro.initial}
        animate={bottomTextIntro.animate}
        transition={bottomTextIntro.transition}
        style={styles.bottomHeadline}
      >
        AI Can Learn & Reason
      </motion.div>
